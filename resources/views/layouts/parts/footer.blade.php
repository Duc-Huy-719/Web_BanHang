<div class="container">
    <div class="row">
        <div class="footer-col-1">
            ...
            <div class="app-logo">
                <img src="{{asset('frontend/asset/image/logo/play-store.png')}}">
                <img src="{{asset('frontend/asset/image/logo/app-store.png')}}">
            </div>
        </div>
        <div class="footer-col-2">
            <img src="{{asset('frontend/asset/image/logo/Mango_store.jpg')}}">
