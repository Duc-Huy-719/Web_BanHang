        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNam/product7.1.jpg')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNam/product7.2.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNam/product7.3.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNam/product7.4.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNam/product7.5.jpg')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNam/product7.webp')}}" alt=""
                        class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Quần Regular Tuysi Basic</h1>
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li>Kiểu dáng rộng rãi, thoải mái, không quá bó sát, phù hợp với nhiều dáng người và dễ dàng
                            di chuyển.</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Quần Regular Tuysi Basic là lựa chọn hoàn hảo cho những ai yêu thích phong cách đơn giản,
                        thanh lịch và thoải mái trong mọi hoạt động hàng ngày.</p><br>
                    <p>- Chất liệu: Vải tuysi, mềm mại, thoáng khí và ít nhăn.</p><br>
                    <p>- Kiểu dáng: Regular fit, mang lại sự thoải mái và dễ chịu khi mặc.</p><br>
                    <p>- Màu sắc: Màu xám, dễ dàng phối hợp với nhiều trang phục khác nhau.</p><br>
                    <p>- Độ dài: Dài đến mắt cá chân</p><br>
                    <p>- Cạp quần: Cạp cao vừa phải, có đỉa để mang thắt lưng.</p><br>
