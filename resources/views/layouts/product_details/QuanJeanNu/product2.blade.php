        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product2.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product2.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product2.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product2.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product2.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product2.jpg')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Quần Jeans loe xẻ gấu</h1>
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li> có độ co giãn nhẹ, diện thoải mái không lo bí bách.</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Quần Jeans loe xẻ gấu là loại trang phục nữ đặc biệt, che khuyết điểm phần đùi hiệu quả, độ
                        dài ngang mắt cá chân, cạp sử dụng khóa và khuy kim
                        loại. </p><br>
                    <p>Bạn có thể lựa chọn mix quần cùng nhiều kiểu áo khác nhau thêm một đôi cao gót sẽ trở thành
                        bộ đôi hách dáng hoàn hảo, không thể bỏ lỡ. </p>
                </div>
            </div>
        </div>
    </div>
