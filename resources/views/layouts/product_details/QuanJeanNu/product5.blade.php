        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product5.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product5.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product5.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product5.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product5.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNu/product5.webp')}}" alt=""
                        class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Quần Jeans suông cạp chéo</h1>
                <span class="span-product">Chất liệu: denim</span>
                <p class="p-product-detail">310,000đ <span>340,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: denim</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li>Quần tạo điểm nhấn qua chi tiết cạp chéo bắt mắt kết hợp gam màu xanh ghi đá thời
                            thượng, chỉ mới liếc nhìn đã đủ thấy vẻ đẹp ấn tượng mà items mang lại. </li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Quần Jeans suông cạp chéo là loại trang phục nữ đặc biệt, chất liệu denim có độ bền cực kỳ
                        cao, kết hợp gam màu xanh ghi đá thời thượng, dễ dàng phối với nhiều kiểu áo, mang lại dáng
                        vẻ trẻ trung cho người mặc.
                    </p><br>
                    <p>Quần tôn dáng, có thể mix cùng áo sơ mi, áo thun... để có set đồ đi làm, đi chơi năng động và
                        không kém phần cá tính.</p>
                </div>
            </div>
        </div>
    </div>
