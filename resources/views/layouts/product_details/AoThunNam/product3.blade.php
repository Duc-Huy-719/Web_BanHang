        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product3.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product3.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product3.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product3.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product3.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product3.jpg')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo Thun Kẻ Ngang Dáng Oversize</h1>
                <span class="span-product">Chất liệu: Cotton</span>
                <p class="p-product-detail">170,000đ <span>200,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: Cotton</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li>Chất liệu vải thun: 95% Cotton 5% Spandex tính năng mềm mịn, thoáng mát</li>
                        <li>Áo cổ bo tròn, tay ngắn, dáng oversize, độ dài ngang hông</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Áo phông họa tiết kẻ ngang trẻ trung, màu sắc tôn da phù hợp mặc hàng ngày. Dễ dàng phối cùng
                        nhiều kiểu quần khác nhau để có 1 set đồ thoải mái, năng động.</p><br>
