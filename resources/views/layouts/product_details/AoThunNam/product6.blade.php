        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product6.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product6.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product6.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product6.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product6.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product6.jpg')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo Thun In Họa Tiết</h1>
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li>Người mẫu: 180cm - 68kg, mẫu mặc size XL</li>
                    </ul>
                </div>
                <h2>Số Lượng:</h2>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Chất liệu 95% Cotton 5% Spandex tính năng mềm mịn, thoáng mát</p><br>
                    <p>Ngực áo in họa tiết sử dụng công nghệ in hiện đại bền màu, không bong</p><br>
