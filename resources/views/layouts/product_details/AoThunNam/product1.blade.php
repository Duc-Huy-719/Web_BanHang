        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product1.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product1.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product1.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product1.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product1.5.jpg')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product1.jpg')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li> Chất liệu vải thun: 95% Cotton, 5% Spandex mềm mại, thoáng mát, co giãn nhẹ</li>
                        <li>Áo thun basic dáng regular fit, tay ngắn, cổ tròn. Ngực in hình chữ thiết kế dập nổi
                        </li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Thiết kế dáng trơn đơn giản, lịch sự, trẻ trung, năng động, dáng tay ngắn thoáng mát trong
                        mùa Xuân Hè.</p><br>
                    <p>Màu xanh tím than tôn da, kiểu dáng lịch sự phù hợp với nhiều sự kiện như: đi học, đi làm, đi
                        chơi.</p><br>
                    <p>Kết hợp với quần âu, quần Jeans, quần Kaki và quần short đều phù hợp. </p>
                </div>
            </div>
        </div>
    </div>
