        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product7.1.jpg')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product7.2.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product7.3.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product7.4.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product7.5.jpg')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoThunNam/product7.webp')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo Thun Nam Phối Sọc Tay</h1>
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li>Phần tay áo và cổ áo được thiết kế phối màu mang một phong cách trẻ trung, tạo điểm nhấn
                            ấn tượng cho tổng thể người mặc
                            Là một kiểu áo đa năng, mặc đi làm, đi chơi, dạo phố hay hẹn hò cùng người ấy đều phù
                            hợp.</li>
            ...
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Được may từ chất vải sợi S.Cafe bảo vệ môi trường, thân thiện với làn da người mặc
                        Vải cafe còn mang sự mát mẻ,nhanh khô, khử mùi tốt và chống được tia cực tím, tia UV </p>
