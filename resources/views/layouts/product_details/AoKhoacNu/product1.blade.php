        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product1.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product1.2.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product1.3.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product1.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product1.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product1.jpg')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo khoác Mangto</h1>
                <span class="span-product">chất liệu: vải dạ</span>
                <p class="p-product-detail">800,000đ <span>950,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: vải dạ</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li>Kiểu dáng: áo măng tô thiết kế dáng dài, cổ bẻ 2 ve, tone màu đỏ trơn</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Áo khoác Mangto là loại trang phục <a href="https://www.coolmate.me/collection/ao-nam"><strong>áo
                                khoác nữ</strong></a> dạ
                        dáng suông có độ dài tới đầu gối. Áo tinh tế với cổ cách điệu, vạt chéo có túi tạo nên phong
                        cách trẻ trung mới mẻ phù hợp với mọi hoàn cảnh của quý cô bận rộn. Áo măng tô ấm áp phù hợp
                        mặc trong tiết thu- đông se lạnh, kết hợp gam màu nâu sang trọng thời thượng đem lại phong
                        cách mới mẻ cho quý cô trong mùa mới.
                    </p>
                </div>
            </div>
        </div>
