        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product4.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product4.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product4.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product4.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product4.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNu/product4.jpg')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo khoác phao giáng dài</h1>
                <span class="span-product">chất liệu: vải tổng hợp</span>
                <p class="p-product-detail">580,000đ <span>610,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: vải tổng hợp</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li>Kiểu dáng: áo khoác thiết kế dáng dài có mũ, có túi 2 bên, tone màu hồng nhạt</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Áo khoác phao giáng dài là loại trang phục <a href="#"><strong>áo khoác nữ</strong></a>có độ
                        dài ngang hông, có lớp lót bên trong để thoải mái khi mặc. Áo tinh tế với cổ bẻ,
                        áo phao kéo khóa nổi bật với họa tiết trần bông ô trám cùng với phối viền tinh tế tạo nên
                        phong cách trẻ trung mới mẻ phù hợp với mọi hoàn cảnh của quý cô bận rộn.
                    </p><br>
                    <p>Áo với thiết kế tay dài phù hợp mặc trong tiết thu- đông se lạnh, có túi áo kết hợp gam màu
                        hồng nhạt trang
                        nhã, nhẹ nhàng đem lại phong cách mới mẻ cho quý cô trong mùa mới.</p>
                </div>
            </div>
        </div>
    </div>
