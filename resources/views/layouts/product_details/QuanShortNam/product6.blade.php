        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNam/product6.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNam/product6.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNam/product6.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNam/product6.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNam/product6.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNam/product6.jpg')}}" alt=""
                        class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Quần Lửng Khaki</h1>
                <span class="span-product">Chất liệu: Khaki</span>
                <p class="p-product-detail">235,000đ <span>250,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: Khaki</li>
                        <li>Được làm từ vải khaki, quần lửng khaki mang lại cảm giác thoáng mát và thoải mái, phù
                            hợp cho các hoạt động ngoài trời và thời tiết nóng.</li>
                        <li>Thiết kế đơn giản nhưng tinh tế, quần lửng khaki dễ dàng phối hợp với nhiều loại áo và
                            phụ kiện, tạo nên phong cách trẻ trung, năng động.</li>
                        <li>Quần lửng khaki phù hợp để mặc đi làm, đi chơi, dạo phố, hoặc tham gia các hoạt động thể
                            thao nhẹ nhàng.</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Chất liệu: Thường làm từ 100% cotton hoặc pha trộn cotton với một lượng nhỏ spandex để tăng
                        độ co giãn và thoải mái.</p><br>
                    ...
                    <p>Quần lửng khaki là sự lựa chọn hoàn hảo cho những ai tìm kiếm sự thoải mái, tiện dụng và
                        phong cách trẻ trung, năng động.</p><br>
                </div>
            </div>
        </div>
    </div>
