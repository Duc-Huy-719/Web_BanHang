        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product8.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product8.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product8.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product8.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product8.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product8.webp')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Quần suông ống rộng xếp ly</h1>
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li>Quần dài ống rộng dáng suông. Quần cạp cao, xếp ly tạo kiểu xòe rộng, mang lại cảm giác
                            thoải mái tuyệt đối.</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Dáng quần này tạo cảm giác chân thon dài, thẳng và che được hầu hết các khuyết điểm. </p><br>
                    <p>Chất liệu Tuysi lên form chuẩn, mềm mại. Quần dễ dàng kết hợp với nhiều kiểu áo khác nhau,
                        phù hợp diện đi chơi hay đi làm.</p>
                </div>
            </div>
        </div>
    </div>
