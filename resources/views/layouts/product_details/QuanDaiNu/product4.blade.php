        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product4.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product4.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product4.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product4.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product4.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanDaiNu/product4.webp')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li>Sử dụng chất kiệu vải Tuysi mềm nhẹ, thoải mái, thiết kế che khuyết điểm tốt giúp nàng
                            tự tin mỗi khi xuất hiện.</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Quần tạo ly cố định, kèm hai túi sườn và độ dài ngang mắt cá chân. Thiết kế chỉn chu, tỉ mỉ,
                        nhấn cạp kiểu độc đáo với những đường gấp nối mới lạ. Nàng công sở có thể kết hợp với nhiều
                        kiểu áo khác nhau để mang đến những bộ trang phục chỉn chu và lịch sự.</p><br>
                    <p>thiết kế mang sứ mệnh tạo nên sự biến chuyển linh hoạt của thời trang mới. Để xây dựng kết
                        nối về cảm xúc, tâm trí thông qua những điểm chạm dịu dàng từ chất vải mềm mại, phom dáng
                        tinh chỉnh vừa vặn và đem đến sự thoải mái êm dịu.</p>
                </div>
            </div>
        </div>
    </div>
