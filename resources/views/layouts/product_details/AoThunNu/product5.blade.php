        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product5.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product5.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product5.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product5.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product5.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product5.jpg')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo Thun Reef Tee</h1>
                <span class="span-product">Chất liệu thun cotton</span>
                <p class="p-product-detail">200,000đ <span>240,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: thun cotton</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li>Đàn hồi, mềm mịn, thấm hút mồ hôi tốt và mang đến cảm giác mặc thoải mái.</li>
                        <li>Áo có thể mix cùng nhiều kiểu quần, chân váy khác nhau phù hợp với phong cách thời trang
                            riêng mỗi người.</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Áo Thun Reef Tee là loại trang phục <a href="#"><strong>áo nữ</strong></a> với kiểu
                        dáng
                        hiện đại cùng dòng chất liệu thoáng mát, xứng đáng để nàng mang ngay về tủ đồ của mình.
                    </p><br>
                    <p>Áo thun cổ tròn, tay ngắn, dáng suông cơ bản, thân trước áo tạo điểm nhấn qua chi tiết đính
                        hoa độc đáo, mới lạ</p><br>
