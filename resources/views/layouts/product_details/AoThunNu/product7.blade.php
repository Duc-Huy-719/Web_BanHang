        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product7.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product7.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product7.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product7.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product7.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoThunNu/product7.webp')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo thun Moments</h1>
                <span class="span-product">Chất liệu thun/span>
                    <p class="p-product-detail">160,000đ <span>200,000đ</span></p>
                    <div class="product-detail-description">
                        <h2>Đặc điểm nổi bật</h2>
                        <ul>
                            <li>Chất liệu: thun</li>
                            <li>Định lượng vải 220gsm dày dặn</li>
                            <li>Áo tạo điểm nhấn qua chi tiết hình in trên thân trước. Chất liệu thun Cotton mềm
                                mịn, thấm hút mồ hôi, thoáng mát khi mặc.</li>
                            <li>Kết cấu vải chắc chắn, phù hợp với các trang phục hè bởi độ mát, thoáng khí của vải.
                                Lựa
                                chọn dễ chịu trong thời tiết Xuân – Hè.</li>
                            <li>Bạn lựa chọn mix áo cùng quần jeans, chân váy, quần suông đều phù hợp và mang đến
                                những outfits thời trang</li>
                            <li>Sản xuất tại Nhà máy Tessellation (TGV), Việt Nam. <a href="#">Xem nhà máy ></a>
                            </li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Áo thun Moments là loại trang phục <a href="#"><strong>áo nữ</strong></a> với kiểu
