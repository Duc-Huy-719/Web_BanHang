        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product2.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product2.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product2.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product2.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product2.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product2.webp')}}" alt=""
                        class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Quần short Lozenge Set</h1>
                <span class="span-product">Chất liệu: lụa</span>
                <p class="p-product-detail">280,000đ <span>320,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: lụa</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li>Set bộ gồm áo sơ mi và quần short, một sự độc đáo và phá cách cho trang phục thời trang
                            nữ vào mùa nắng nóng.
                        </li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Quần short Lozenge Set là loại trang phục nữ đặc biệt, giúp người mặc trải nghiệm cảm giác
                        mềm mại, nhẹ nhàng và thoải mái nhất. Lựa chọn vải sinh học làm từ bột gỗ bạch đàn 100% tự
                        nhiên với sợi vải luôn thông thoáng và khả năng kháng khuẩn, khử khuẩn cao
                    </p><br>
                    <p>Set bộ nổi bật với nền họa tiết hình thoi đan xen. Rất đáng để thêm vào tủ đồ nàng muốn thể
                        hiện phong cách cá nhân sáng tạo.</p>
                </div>
            </div>
        </div>
    </div>
