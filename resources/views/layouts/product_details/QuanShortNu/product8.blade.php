        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product8.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product8.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product8.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product8.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product8.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product8.webp')}}" alt=""
                        class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Quần short Ladies Rayon</h1>
                <span class="span-product">Chất liệu: Tuysi </span>
                <p class="p-product-detail">330,000đ <span>350,000đ</span></p>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Quần short Ladies Rayon có set bộ trẻ trung, năng động cho mùa hè với áo gile cách điệu cùng
                        quần suông ống rộng tôn dáng. Thiết kế áo cổ V, kiểu dáng gile thời thượng. Quần short cạp
                        cao, ống suông, có thêm hai túi sườn năng động.</p>
                    <br>
                    <p>thiết kế mang sứ mệnh tạo nên sự biến chuyển linh hoạt của thời trang mới. Để xây dựng kết
                        ...
                        tinh chỉnh vừa vặn và đem đến sự thoải mái êm dịu.</p><br>
