        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product1.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product1.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product1.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product1.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product1.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanShortNu/product1.webp')}}" alt=""
                        class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Quần short cạp đai mây</h1>
                <span class="span-product">Chất liệu: tuysi</span>
                <p class="p-product-detail">290,000đ <span>330,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: tuysi</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li>Chất liệu tuysi là loại vải cao cấp, thanh lịch, sang trọng mà vẫn đảm bảo sự thoải mái.
                        </li>
                        <li>Độ dày vải vừa phải, thoải mái, thoáng mát</li>
                        <li>Phù hợp mặc khi đi dự tiệc, đi chơi</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Quần short cạp đai mây là loại trang phục nữ đặc biệt, một thiết kế quần short basic mà bất
                        kì cô nàng công sở cũng nên sở hữu.
                    </p><br>
                    <p>Quần dáng suông thoải mái, cạp cao tôn dáng giúp tạo kiểu sơ vin cực sang khi cạp có phối phụ
                        kiện kim loại. Thiết kế 2 túi chéo 2 bên tiện lợi kèm khóa kéo phía sau.</p>
                </div>
            </div>
        </div>
    </div>
