        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNam/product8.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNam/product8.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNam/product8.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNam/product8.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNam/product8.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoKhoacNam/product8.webp')}}" alt=""
                        class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li>Chất liệu siêu nhẹ giúp áo không tạo cảm giác nặng nề khi mặc, dễ dàng di chuyển và hoạt
                            động.</li>
                        <li>Kiểu dáng hiện đại, nam tính, phù hợp với nhiều phong cách thời trang khác nhau.</li>
                        <li>Kiểu dáng hiện đại, nam tính, phù hợp với nhiều phong cách thời trang khác nhau.</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p> Lớp vỏ ngoài: Polyester cao cấp, chống thấm nước, chống gió.</p><br>
                    <p>Lớp lót bên trong: Lông vũ hoặc bông tổng hợp, giúp cách nhiệt và giữ ấm.</p><br>
                    <p>Thời trang và tiện lợi: Kiểu dáng thời trang, dễ phối đồ, và có thể mặc trong nhiều dịp khác
                        nhau.</p><br>
                    <p>Tiện dụng: Dễ dàng mang theo khi đi du lịch, dã ngoại, hoặc các hoạt động ngoài trời.</p>
                </div>
            </div>
        </div>
    </div>
