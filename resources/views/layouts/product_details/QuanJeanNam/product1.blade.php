        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product1.1.jpg')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product1.2.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product1.3.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product1.4.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product1.5.jpg')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product1.webp')}}" alt=""
                        class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Quần jeans Slim fit</h1>
                <span class="span-product">Chất liệu: Denim</span>
                <p class="p-product-detail">350,000đ <span>380,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: Denim</li>
                        <li>Chất liệu thường là vải denim với độ co giãn nhẹ, giúp người mặc dễ di chuyển và thoải
                            mái.</li>
                        <li>Quần có màu xanh đậm, một lựa chọn phổ biến và dễ phối đồ.</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p> Quần jeans Slim fit thích hợp cho nhiều phong cách từ casual đến semi-formal, dễ dàng phối
                        với áo phông, áo sơ mi hay áo khoác.</p><br>
                    <p>Thiết kế:</p><br>
                    <p>- Ống quần: Ống quần có kiểu dáng slim, ôm sát từ đùi xuống mắt cá.</p><br>
                    <p>- Cạp quần: Cạp quần vừa phải, có thể có các chi tiết như nút và khóa kéo để dễ dàng mặc vào
                        và tháo ra.</p><br>
