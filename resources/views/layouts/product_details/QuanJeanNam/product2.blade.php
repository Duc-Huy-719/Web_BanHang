        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product2.1.jpg')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product2.2.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product2.3.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product2.4.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product2.5.jpg')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/QuanJeanNam/product2.jpg')}}" alt=""
                        class="big-img">
                </div>
            </div>
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li>Chất liệu thường là vải denim với độ co giãn nhẹ, giúp người mặc dễ di chuyển và thoải
                            mái.</li>
                        <li>Quần có màu đen, một lựa chọn phổ biến và dễ phối đồ.</li>
