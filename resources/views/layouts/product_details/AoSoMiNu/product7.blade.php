        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product7.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product7.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product7.3.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product7.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product7.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product7.webp')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo sơ mi trắng cổ đá</h1>
                <span class="span-product">Vải thô</span>
                <p class="p-product-detail">560,000đ <span>650,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: Vải thô</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li> Kiểu dáng: ​áo sơ mi thiết kế cổ bẻ đính đá, tay bồng, tone màu trắng trơn</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    ...
                    <p>Áo sơ mi cổ bẻ đính đá, tay bồng, tone màu trắng trơn với cách xếp lớp nhẹ nhàng vừa che
                        khuyết điểm</p>
                </div>
            </div>
        </div>
