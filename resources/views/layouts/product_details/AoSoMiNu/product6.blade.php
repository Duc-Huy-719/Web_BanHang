        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product6.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product6.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product6.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product6.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product6.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product6.jpg')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo sơ mi tay cách điệu</h1>
                <span class="span-product">Rayon, Poly, Spandex</span>
                <p class="p-product-detail">610,000đ <span>740,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: Rayon, Poly, Spandex</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Áo sơ mi tay cách điệu là loại trang phục <a
                            href="https://www.coolmate.me/collection/ao-nam"><strong>áo nữ</strong></a>Với kiểu dáng
                        hiện đại cùng dòng chất liệu thoáng mát, xứng đáng để nàng mang ngay về tủ đồ của mình.
                    </p><br>
                    <p>Áo sơ mi cổ tròn, dáng suông. Tay áo tạo kiểu cánh tiên với cách xếp lớp nhẹ nhàng vừa che
                        khuyết điểm bắp tay vừa tạo hiệu ứng bắt mắt. </p><br>
                    <p>Chân váy bút chì cạp cao, độ dài qua gối, phối các đường ly nổi đan xen. Đặc biệt, thiết kế
                        có thêm túi sườn tiện lợi. </p>
                </div>
            </div>
        </div>
    </div>
...
<div class="row-grid row-grid-hot-products">
    ...
    <div class="hot-product-item">
        <div class="image-container">
            ...
            <div class="overlay">
                <div class="overlay-content"><a href="{{asset('/layouts/product_details/AoSoMiNam/product4')}}">Xem
                        thêm</a>
                </div>
            </div>
        </div>
