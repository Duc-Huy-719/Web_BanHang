        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product2.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product2.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product2.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product2.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product2.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/AoSoMiNu/product2.jpg')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Áo sơ mi Tencel tay lỡ</h1>
                <span class="span-product">Tencel sinh học</span>
                <p class="p-product-detail">550,000đ <span>800,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: Tencel sinh học</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li>Vải độ bền màu cao, ít bị co giãn, giữ được phom tốt.</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Áo sơ mi Tencel tay lỡ là loại trang phục <a
                            href="https://www.coolmate.me/collection/ao-nam"><strong>áo nữ</strong></a> có thiết kế
                        thanh lịch và nữ tính, áo cổ tròn, dáng suông phù hợp mọi vóc dáng mà còn dễ dàng che đi
                        khuyết điểm.
                    </p><br>
                    <p>Tay áo lỡ, tạo độ bồng nhẹ, nữ tính. Thân trước đính thêm các chi tiết hoa nổi, dễ dàng thu
                        hút mọi ánh nhìn. Gợi ý nàng mix áo cùng quần hay chân váy để có set đồ hoàn chỉnh.</p>
                </div>
            </div>
        </div>
    </div>
