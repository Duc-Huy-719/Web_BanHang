        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product4.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product4.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product4.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product4.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product4.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product4.webp')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Đầm chấm bi cổ bẻ</h1>
                <span class="span-product">Chất liệu: vải thô</span>
                <p class="p-product-detail">980,000đ <span>1,000,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: vải thô</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li> Kiểu dáng: đầm thiết kế dáng chữ A dài qua gối, tone màu xanh than phối họa tiết chấm
                            bi trắng, cổ bẻ</li>
            ...
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Đẹp như bông hoa khoe sắc qua thiết kế đầm tạo kiểu vừa thanh lịch, tinh tế vừa nhẹ nhàng,
                        bay bổng.</p><br>
                    <p>Đầm dáng xòe nhẹ, độ dài qua gối mang đến sự thoải mái.</p><br>
