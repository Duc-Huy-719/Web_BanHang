        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product8.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product8.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product8.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product8.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product8.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product8.webp')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                ...
                <div class="product-detail-description">
                    ...
                    <ul>
                        ...
                        <li>Kiểu dáng: đầm thiết kế xếp li dáng chữ A dài qua gối, tone màu xanh than</li>
        ...
        <div class="row-grid row-grid-one-item">
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Phần chân váy dài xếp ly xòe duyên dáng. Thiết kế tay liền, cổ điểm chữ V khuyết nhẹ khiến
                        chiếc đấm thêm thu hút hơn.</p><br>
                    <p>Chiếc đầm không chỉ tôn dáng, che khuyết điểm cơ thể mà còn mang lại vẻ thanh lịch, quyến rũ
                        cho người mặc.</p><br>
                    <p>Đầm phù hợp diện đi làm hoặc đến một bữa tiệc tối sang trọng với trang sức và ví cầm tay.
                        Những phụ kiện đi kèm nên là những loại có dây bản nhỏ như quai túi hay dây giày, trông bạn
                        sẽ quyến rũ và thanh lịch hơn với phong cách quý phái này.</p>
                </div>
            </div>
        </div>
</section>
