        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product3.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product3.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product3.3.jpg')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product3.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product3.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/Vay_Dam/product3.webp')}}" alt="" class="big-img">
                </div>
            </div>
            <div class="product-detail-right">
                <h1>Đầm hoa vàng hạ eo</h1>
                <span class="span-product">Chất liệu: vải voan</span>
                <p class="p-product-detail">920,000đ <span>950,000đ</span></p>
                <div class="product-detail-description">
                    <h2>Đặc điểm nổi bật</h2>
                    <ul>
                        <li>Chất liệu: vải voan</li>
                        <li>Định lượng vải 220gsm dày dặn</li>
                        <li> Kiểu dáng: đầm thiết kế dáng suông dài qua gối, kết hợp họa tiết hoa tone màu vàng</li>
                        <li>Thiết kế tạo kiểu tay ngắn bồng nhẹ, chiết đai eo thon gọn. Phần cổ tròn thêm điểm nhấn
                            thắt nơ mềm mại, tăng vẻ đẹp duyên dáng và nữ tính cho đầm.</li>
            ...
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    <p>Đẹp như bông hoa khoe sắc qua thiết kế đầm tạo kiểu vừa thanh lịch, tinh tế vừa nhẹ nhàng,
                        bay bổng.</p><br>
                    <p>Đầm dáng xòe nhẹ, độ dài ngang gối mang đến sự thoải mái và dễ dàng di chuyển.</p><br>
                    <p>Gợi ý nàng phối đầm với giày cao gót, giày bệt, hoặc giày sandal. Có thể kết hợp với túi xách
                        và phụ kiện để tạo nên phong cách riêng biệt cho từng dịp khác nhau.</p>
                </div>
            </div>
        </div>
</section>
