        ...
        <div class="row-grid-product-detail">
            <div class="product-detail-left">
                <div class="product-img-items">
                    <img src="{{asset('frontend/asset/image/product/SoMiNam/product4.1.webp')}}" alt=""
                        class="small-img active">
                    <img src="{{asset('frontend/asset/image/product/SoMiNam/product4.2.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/SoMiNam/product4.3.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/SoMiNam/product4.4.webp')}}" alt=""
                        class="small-img">
                    <img src="{{asset('frontend/asset/image/product/SoMiNam/product4.5.webp')}}" alt=""
                        class="small-img">
                </div>
                <div class="big-img-container">
                    <img src="{{asset('frontend/asset/image/product/SoMiNam/product4.webp')}}" alt="" class="big-img">
                </div>
            </div>
            ...
            <div class="product-detail-content">
                ...
                <div class="produt-detail-content-text">
                    ...
                    <p>Dáng áo Slim fit ôm gọn cơ thể và tôn dáng người mặc. Tạo cho nam giới phong thái đĩnh đạc,
                        hiện đại, chuyên nghiệp và lịch lãm. Thích hợp mặc công sở, đi
